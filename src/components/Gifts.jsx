...
export default function Gifts() {
  const gifts = useMemo(() => [
    { id: 1, position: [-1.8, 0, -32], color: '#ffffff', ribbonColor: '#d4af37', rotationY: Math.PI / 6, message: 'I Love You!' },
    { id: 2, position: [1.8, 0, -32.5], color: '#2c303a', ribbonColor: '#ff6b9a', rotationY: -Math.PI / 8, message: 'You are amazing!' }
  ], [])
